...
setup.sextoys = [
	...
	},
	{
		...
		description: "Для анальных ласок. Этот предмет может временно находиться в анальном отверстии, либо же с ним можно поиграться посредством поступательных движений.",
		cost: 8000,
		type: ["dildo", "anal"],
		category: "butt_plug",
		wearable: 1,
	...
	},
	{
		...
		description: "Ручной молокоотсос для груди.",
		cost: 5000,
		wearable: 0,
		size: 3,
		category: "breastpump",
