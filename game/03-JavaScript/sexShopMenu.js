...
setup.sextoys = [
	{
		...
		description: "15-и сантиметровый дилдо.",
		cost: 5000,
		category: "dildo",
		wearable: 0,
		size: 2,
	...
	},
	{
		index: 2,
		name: "anal beads",
		namecap: "Анальные шарики",
		name_underscore: "anal_beads",
		description: "Для анальных игр. Этот предмет можно вставить в попу или играть с ним.",
		cost: 8000,
		type: ["dildo", "anal"],
		category: "butt_plug",
		wearable: 1,
	...
	},
	{
		...
		description: "Вибрации, производимые этим предметом, дарят мощные оргазмы. Хорошо подходит для тех, кто только начинает знакомиться с секс-игрушками.",
		cost: 12000,
		wearable: 0,
		size: 0,
		category: "vibrator",
	...
	},
	{
		index: 4,
		name: "butt plug",
		namecap: "Анальная пробка",
		name_underscore: "butt_plug",
		description: "Для анальных игр. Этот предмет может быть вставлен в попу или играться с ним.",
		cost: 8000,
		wearable: 1,
		size: 2,
		category: "butt_plug",
	...
	},
	{
		...
		clothes_index: 33,
		description: "Одевается на бедра. Используется для секса с проникновением.",
		cost: 8000,
		wearable: 1,
		size: 2,
		category: "strap-on",
	...
	},
	{
		...
		description: "Лубрикант, подходящий для сексуальных целей. 3 использования на бутылку.",
		cost: 2000,
		wearable: 0,
		size: 3,
		category: "lube",
	...
	},
	{
		...
		description: "Мастурбатор-рукав для члена. Изготовлен из материала, похожего на плоть..",
		cost: 8000,
		wearable: 0,
		category: "stroker",
		type: ["stroker"],
	...
	},
	{
		...
		namecap: "Таблетки афродизиака",
		name_underscore: "aphrodisiac_pills",
		description: "В упаковке три таблетки-афродизиака. В инструкции сказано, что для усиления ощущений перед сексом нужно принять 'соответствующее количество'.",
		cost: 4000,
		wearable: 0,
		size: 3,
	...
	},
	{
		index: 11,
		name: "breast pump",
		namecap: "молокоотсос для груди",
		name_underscore: "breast_pump",
		description: "Ручной молокоотсос.",
		cost: 5000,
		wearable: 0,
		size: 3,
		category: "breastpump",
