...
Weather.Sky = (() => {
	...
	function updateTooltip() {
		...
		const debug = V.debug
			...
			<br><span class="blue">Overcast amount:</span> <span class="yellow">${round(_fadables.overcast.factor, 2)}</span>
			<br><span class="blue">Fog amount:</span> <span class="yellow">${round(Weather.fog, 2)}</span>
