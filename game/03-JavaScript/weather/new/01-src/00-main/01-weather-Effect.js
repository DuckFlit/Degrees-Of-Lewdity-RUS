...
WeatherCanvas.Effect = class Effect {
	...
	addEffect(effectName, params, bindings, condition) {
		...
		const newEffect = new WeatherCanvas.Effect(effectConfig, condition, null, params);
	 ...
	 *
	 * @returns {Promise} A promise that resolves when the drawing is complete
	 */
	draw() {
		this.canvas.clear();
