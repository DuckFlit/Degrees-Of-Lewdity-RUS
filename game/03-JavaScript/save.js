	...
	switch (type) {
		...
		case "general":
			result = {
				...
				maleChanceSplit: { boolLetter: true, bool: true },
				maleChanceMale: { min: 0, max: 100, decimals: 0, randomize: "encounter" },
				maleChanceFemale: { min: 0, max: 100, decimals: 0, randomize: "encounter" },
				...
				beastMaleChanceSplit: { boolLetter: true, bool: true },
				beastMaleChanceMale: { min: 0, max: 100, decimals: 0, randomize: "encounter" },
				beastMaleChanceFemale: { min: 0, max: 100, decimals: 0, randomize: "encounter" },
				...
				bodywritingLvl: { min: 0, max: 3, decimals: 0 },
				...
				toymultiplepenetration: { boolLetter: true, bool: true },
				speechpregnancydisable: { boolLetter: true, bool: true },
				hypnosisdisable: { boolLetter: true, bool: true },
				ruffledisable: { boolLetter: true, bool: true },
				forcedcrossdressingdisable: { boolLetter: true, bool: true },
