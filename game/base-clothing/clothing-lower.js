...
function initLower() {
	setup.clothes.lower = [
...

		{
			index: 100,
			name: "cardigan skirt",
			name_cap: "Cardigan skirt",
			variable: "cardigan skirt",
			integrity: 160,
			integrity_max: 160,
			fabric_strength: 30,
			reveal: 300,
			...
			warmth: 30,
			cost: 7000,
			description: "Cardigan must remain fashionably tied around waist at all times.",
			shop: ["clothing"],
			accessory: 1,
			accessory_colour: 0,
			accessory_colour_options: [],
			...
			cursed: 0,
			location: 0,
			iconFile: "cardigan_skirt.png",
			accIcon: "cardigan_skirt_acc.png",
		},
